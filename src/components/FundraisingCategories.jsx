  ...
  return (
    <section className="relative w-full border-t border-b border-white/[0.08] bg-black my-10 mt-30">
      <div className="max-w-[1440px] mx-auto w-full grid grid-cols-1 md:grid-cols-2">
        ...
        {/* Startup Block */}
        <div className="neon-border group relative h-[350px] md:h-[450px] border-b md:border-b-0 md:border-r border-white/[0.08] p-8 md:p-16 flex flex-col justify-between overflow-hidden cursor-pointer bg-black hover:bg-[#050505] transition-all duration-500 hover:border-[#eaff00]/50 hover:shadow-[0_0_30px_rgba(234,255,0,0.15)] z-0 hover:z-10">
          ...
          <div className="relative z-10 flex items-end mt-auto origin-left">
             <div className="w-0 overflow-hidden opacity-0 group-hover:w-[46px] group-hover:opacity-100 transition-all duration-500 ease-[cubic-bezier(0.25,1,0.5,1)] flex items-end mb-[6px] md:mb-[8px] justify-start">
                 <svg width="34" height="34" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="neon-text neon-border rounded p-1 text-white shrink-0">
             ...
             <h2 className="text-white group-hover:text-[#050505] group-hover:[-webkit-text-stroke:1px_#eaff00] text-[42px] md:text-[54px] leading-[1.05] font-semibold tracking-tight transform group-hover:translate-x-1 transition-all duration-500 ease-[cubic-bezier(0.25,1,0.5,1)] whitespace-nowrap">
        ...
        {/* Fund Block */}
        <div className="neon-border group relative h-[350px] md:h-[450px] border-t md:border-t-0 p-8 md:p-16 flex flex-col justify-between overflow-hidden cursor-pointer bg-black hover:bg-[#050505] transition-all duration-500 border border-transparent hover:border-[#eaff00]/50 hover:shadow-[0_0_30px_rgba(234,255,0,0.15)] z-0 hover:z-10">
